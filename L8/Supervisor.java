...
public class Supervisor {
    public static void main(String[] args) {
        ...
        ps_o1.SetName("ps_o1");
        ps_o1.Value = new TransferOperation("localhost", "1080", "p_i2");
        pn.PlaceList.add(ps_o1);

        DataRELQueue ps_1 = new DataRELQueue();
        ps_1.SetName("ps_1");
        ps_1.Value.Size = 10;
        pn.PlaceList.add(ps_1); /*??how to set value to r, e, l??*/
        ...
        Condition T2Ct3 = new Condition(ts_2, "ps_1.r", TransitionCondition.NotEqual, "ps_2");
        T2Ct1.SetNextCondition(LogicConnector.AND, T2Ct2);
        T2Ct1.SetNextCondition(LogicConnector.AND, T2Ct3);

        GuardMapping grdT2 = new GuardMapping();
        grdT2.condition = T2Ct1;

        grdT2.Activations.add(new Activation(ts_2, "ps_o1", TransitionOperation.SendOverNetwork, "ps_1.r"));
        grdT2.Activations.add(new Activation(ts_2, "ps_3", TransitionOperation.PopElement_R_E, "ps_1.e"));
        ...
        grdT3.Activations.add(new Activation(ts_3, "ps_2", TransitionOperation.Move, "ps_i2"));
        grdT3.Activations.add(new Activation(ts_3, "ps_o2", TransitionOperation.Move, "ps_i2"));
